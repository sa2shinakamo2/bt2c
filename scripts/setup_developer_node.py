...
class DeveloperNodeSetup:
    ...
    def create_developer_wallet(self):
        ...
        try:
            # Generate new wallet with BIP39 seed phrase (256-bit)
            print("\n🔄 Generating new wallet with BIP39 seed phrase...")
            wallet_data = wallet_manager.generate_wallet(None, password)  # None to generate a new seed phrase
